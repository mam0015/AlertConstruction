const CACHE='alert-tradie-pro-v45';
const ASSETS=[
  ...
  './builder/','./builder/index.html','./builder/app.js','./builder/team-management.css','./builder/team-management.js','./builder/photo-timeline.css','./builder/photo-timeline-api.js','./builder/photo-timeline.js','./builder/booklet-pdf.js','./builder/finance.css','./builder/finance-api.js','./builder/finance.js','./builder/operation-overview.css',
