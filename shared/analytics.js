(function(global){
  ...
  const ROUTES={
    ...
    'plan-ai':'ai-plan-estimator','quote-analysis':'quote-price-analysis',invoice:'invoice-generator',
  ...
  const trackableTools=new Set(['electrical','plumbing','cladding','renovation-budget','property-value-guide','permit-checklist','ai-plan-estimator','quote-price-analysis','invoice-generator','projects-schedule','price-catalogue','site-checklist']);
