...
type JobRequest = { id: number; code: string; requestType: "Project Request" | "Job Request"; customerName: string; contact: string; service: string; suburb: string; submittedAt: string; status: string; priority: string; summary: string; assignedTo: string; updatedAt: string; attachmentCount: number };
