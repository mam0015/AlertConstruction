...
for(const marker of ['ac-auth-callback-v22','brand-logo-light','alert-construction-logo-ac-light.svg','luxury-builder-hero.webp','editorial-grid']){const sources=read('sw.js')+'\n'+home+'\n'+shell+'\n'+read('CHANGES_AND_TESTS.txt');if(!sources.includes(marker))fail(`Luxury builder or auth callback mode is missing ${marker}`)}
