(function(){
  ...
  const questions={
    ...
    exterior:[
      {id:'claddingArea',label:'New cladding area (m²)',type:'number',min:0,step:1,default:0,help:'Thermory material pricing uses the protected Cladding calculator rate.'},
