...
var client_references_default = {
	"009ec46bb0c1": async () => {
		const m = await import("./assets/AdminDashboard-Ck-hYs7a.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"03672e79ab9b": async () => {
		const m = await import("./assets/PendingAccess-yYJQP0tu.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"07e5d253561f": async () => {
		const m = await import("./assets/OwnerDashboard-BUnYP11R.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-DyUyeU-w.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"422551a3b4ff": async () => {
		const m = await import("./assets/page-Boouj4H7.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-BUwsL7Qc.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-RbVdSa6p.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"7546c08984d7": async () => {
		const m = await import("./assets/TaskInbox-D7BIzc6V.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"a9766214951c": async () => {
		const m = await import("./assets/SiteSupervisor-FMl7Go4V.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-rFQpyoyn.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"d74b842818c6": async () => {
		const m = await import("./assets/WorkerDashboard-BodrIxxU.js");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { stripBasePath as C, hasBasePath as S, withBasePath as _, getPrefetchedUrls as a, require_react as b, useParams as c, createRscRequestHeaders as d, app_ssr_entry_default as default, createRscRequestUrl as f, toSameOriginAppPath as g, toBrowserNavigationHref as h, handleSsr, getMountedSlotsHeader as i, usePathname as l, resolveRelativeHref as m, getCurrentInterceptionContext as n, navigateClientSide as o, isHashOnlyBrowserUrlChange as p, getLayoutSegmentContext as r, prefetchRscResponse as s, require_jsx_runtime as t, useRouter as u, isDangerousScheme as v, __toESM as w, VINEXT_MOUNTED_SLOTS_HEADER as x, AppElementsWire as y };
